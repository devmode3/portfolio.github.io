    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.1 * 1000}>
          <p>
          Hi there! I'm Nelson Kipkorir, a highly motivated Information Technology Student with a passion for Full Stack Web Development, Machine Learning and Problem-solving.  
          </p>
        </ScrollAnimation>
